...
Разработка модуля программы для поиска оптимальных норм внесения минеральных удобрений на сельскохозяйственные поля с помощью целочисленного линейного программитрования.
## Цель модели
